...
y, sr = librosa.load('Cheese_N_Pot-C_-_16_-_The_Raps_Well_Clean_Album_Version.mp3', duration=120)
...
y_ = librosa.istft(S_foreground)
librosa.output.write_wav("test.wav",y_,sr)
